    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Symbol = table.Column<int>(type: "integer", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Symbol = table.Column<int>(type: "integer", nullable: false),
                    ExecutionPrice = table.Column<decimal>(type: "numeric(18,8)", precision: 18, scale: 8, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Balances_UserId_AssetSymbol",
                table: "Balances",
                columns: new[] { "UserId", "AssetSymbol" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Orders_Symbol_Status_CreatedAt",
                table: "Orders",
                columns: new[] { "Symbol", "Status", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trades_Symbol_ExecutedAt",
                table: "Trades",
